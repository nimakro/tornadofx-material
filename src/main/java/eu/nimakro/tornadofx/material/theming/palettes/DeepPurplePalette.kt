...
object DeepPurplePalette: Palette {
    ...
    override val h50   = c("#ede7f6")
    override val h100  = c("#d1c4e9")
    override val h200  = c("#b39ddb")
    override val h300  = c("#9575cd")
    override val h400  = c("#7e57c2")
    override val h500  = c("#673ab7")
    override val h600  = c("#5e35b1")
    override val h700  = c("#512da8")
    override val h800  = c("#4527a0")
    override val h900  = c("#311b92")
    override val hA100 = c("#b388ff")
    override val hA200 = c("#7c4dff")
    override val hA400 = c("#651fff")
    override val hA700 = c("#6200ea")
